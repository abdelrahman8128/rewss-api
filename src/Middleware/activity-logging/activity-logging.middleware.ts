...
export const activityLoggingMiddleware = (
  entityType: "ad" | "stock" | "user" | "order" | "payment" | "auth" | "system" | "other" = "other",
  customAction?: string,
 ...
 */
function getActionFromRequest(req: LoggingRequest, customAction?: string): string {
 ...
 */
function getCategoryFromAction(action: string, entityType: string): "create" | "read" | "update" | "delete" | "auth" | "transaction" | "system" | "other" {
  // Authentication actions
 ...
 */
function generateDescription(req: LoggingRequest, action: string, entityType: string, customDescription?: string): string {
 ...
 */
function getEntityIdFromRequest(req: LoggingRequest): Types.ObjectId | undefined {
 ...
 */
export const authActivityMiddleware = (action: 'login' | 'logout' | 'register' | 'password_reset') => {
