...
exports.editQuestionController = (0, express_async_handler_1.default)(async (req, res) => {
    const service = new question_service_1.default();
    const { questionId } = req.params;
    const { content } = req.body;
    try {
        const updated = await service.editQuestion(questionId, content, req.user._id);
        res
